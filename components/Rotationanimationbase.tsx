...
const Rotationanimationbase = () => {
  return (
    <>
      <div className="w-[1000px] h-[1000px] rounded-full rotate-[0deg] hover:rotate-[450deg] hover:scale-[1.4] transition-transform duration-700">
        <>
...
export default Rotationanimationbase;
